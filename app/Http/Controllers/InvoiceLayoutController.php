...
// add files here 
    ...
    $desgin= ['classic' => __('lang_v1.classic') .  ' (' . __('lang_v1.for_normal_printer') . ')',
                ...
                'green' => __('lang_v1.green') . ' (' . __('lang_v1.new-design'). ')',
                'red' => __('lang_v1.red') . ' (' . __('lang_v1.new-design'). ')',
                'new' => __('lang_v1.new') . ' (' . __('lang_v1.new'). ')'
            ];    
    $files = Storage::disk('design')->allFiles('files');
    foreach ($files as $file){
    $arr = explode(".", $file, 2);
    $res = $arr[0];
    $final = str_replace("/" , "." , $res);

    $desgin[$final] = __('lang_v1.'.$final) . ' (' . __('lang_v1.'.$final). ')';
