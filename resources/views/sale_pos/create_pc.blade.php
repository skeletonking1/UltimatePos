					...
					<div class="box box-solid mb-12">
						<div class="box-body pb-0">
							...
							<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
								@include('sale_pos.partials.pos_form_pc')
    ...
    $(document).ready(function () {
        ...
        $("#searchButton").click(function () {
            ...
            if (search != "") {
                ...
                $.ajax({
                    url: 'http://ultimatepos.2030saudivision.com/products/list',
                    type: 'get',
                    data: { term: search },
                    dataType: 'html',
                    success: function (response) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            var qty_available = response[i]['qty_available'];
                            $("#searchResult  > tbody:last-child").append(
                                " <tr>" + " <td>" + id + "</td>" + "<td>" + name + "</td>" + "<td>" + selling_price + "</td>" + "<td>" + qty_available + "</td>" + " </tr>"
        ...
        $("#searchResult > tbody").on('click', 'tr', function () {
           ...
           pos_product_row( $(this).children()[0].innerHTML
            );
            // alert('Clicked row ' + $(this).children().each(function () {
