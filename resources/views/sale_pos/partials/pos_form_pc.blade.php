			...
			<div class="input-group mr-8">
				<div class="input-group-btn">     
				 <button type="button" class="btn btn-info btn-lg  " data-toggle="modal"
                                            data-target="#myModal">     @lang('sale.pos_pc')   </button>
                                            ...
                                            <div class="modal-body">
                                                <div class="active-pink-3 active-pink-4 mb-4">
                                                    <input class="form-control" type="text" placeholder="Search Items"
                                                        aria-label="Search" id="searchParam" />
                                                </div>
                                                <div id="search-r">
                                                    <div class="table-responsive table-bordered" id="receipt">
				...
				<span class="input-group-btn">
					...
					<button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product" data-href="{{action('ProductController@quickAdd')}}" data-container=".quick_add_product_modal"><i class="fa fa-plus-circle text-primary fa-lg">@lang('sale.add_item')</i></button>
				</span>
			</div>
		</div>
	</div>
