...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    ...
    <a class="navbar-brand d-block d-lg-none" href="http://ultimatepos.2030saudivision.com/invoice-schemes" >الصفحة الرئيسية</a>
      <a class="navbar-link d-none" id="multi_selection_toggle">
        ...
        <span class="d-none d-lg-inline">{{ trans('laravel-filemanager::lfm.menu-multiple') }}</span>
            ...
            <a href="http://ultimatepos.2030saudivision.com/invoice-schemes" class="float-left" id="desktoponly">الـصفحة الرئيسية</a>
            </div>            </div>
